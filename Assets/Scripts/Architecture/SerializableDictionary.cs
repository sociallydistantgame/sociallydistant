...
// SOURCEs
// Restitched, which got it from:
// here: https://forum.unity.com/threads/finally-a-serializable-dictionary-for-unity-extracted-from-system-collections-generic.335797/
...
namespace Architecture
{
    ...
    /// <summary>
    /// Needs to be subclased to work. See USAGE in definition.
    /// </summary>
    [Serializable, DebuggerDisplay("Count = {Count}")]
    public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        [SerializeField, HideInInspector] int[] _Buckets = Array.Empty<int>();
        [SerializeField, HideInInspector] int[] _HashCodes = Array.Empty<int>();
        [SerializeField, HideInInspector] int[] _Next = Array.Empty<int>();
        ...
        [SerializeField, HideInInspector] TKey[] _Keys = Array.Empty<TKey>();
        [SerializeField, HideInInspector] TValue[] _Values = Array.Empty<TValue>();
