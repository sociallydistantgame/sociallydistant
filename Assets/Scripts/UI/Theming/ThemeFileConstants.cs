...
namespace UI.Theming
{
	public static class ThemeFileConstants
	{
		...
		public static readonly string BackdropName = "backdrop.xml";
		public static readonly string TerminalName = "terminal.xml";
		public static readonly string ShellName = "shell.xml";
		public static readonly string ColorTableName = "colors.xml";
	}
}