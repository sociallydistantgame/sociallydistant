...
namespace Com.TheFallenGames.OSA.Core
{
    ...
    public class ItemsDescriptor
	{
		...
		/// </summary>
		public ReadOnlyCollection<int> GetIndicesInViewOfNonDefaultItems() { return _Keys.AsReadOnly(); }
		...
		/// </summary>
		/// <returns></returns>
		public Dictionary<int, SizeInfo> GetSizeInfosOfNonDefaultItems() { return _SizeInfos; }
		...
		void ClearAllKeysAndSizes()
		{
			...
			_SizeInfos = new Dictionary<int, SizeInfo>();
			_Keys = new List<int>();
		}
