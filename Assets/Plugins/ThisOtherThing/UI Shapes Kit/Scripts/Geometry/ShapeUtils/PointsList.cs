...
namespace ThisOtherThing.UI.ShapeUtils
{
	public class PointsList
	{
		...
		public class PointListProperties
		{
			...
			[Utils.Min(0.0f)] public float RoundingDistance = 0.0f;
		...
		public class PointListGeneratorData
		{
			...
			[Utils.Min(1.0f)] public float Width = 10.0f;
			[Utils.Min(1.0f)] public float Height = 10.0f;

			[Utils.Min(1.0f)] public float Radius = 10.0f;
			...
			[Utils.Min(2)] public int Resolution = 10;
