...
namespace ThisOtherThing.UI
{
	public class GeoUtils
	{
		...
		public class RoundingProperties
		{
			...
			[Utils.Min(2)]public int FixedResolution = 10;
			[Utils.Min(0.01f)]public float ResolutionMaxDistance = 4.0f;
		...
		public class ShadowsProperties
		{
			...
			[Utils.Min(0.0f)] public float Distance = 0.0f;
		...
		public class ShadowProperties
		{
			...
			[Utils.Min(0.0f)] public float Size = 5.0f;
