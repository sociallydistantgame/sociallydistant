...
namespace SociallyDistant.Core
{
        ...
        IDisposable
    {
        ...
        internal WorldManager(SociallyDistantGame gameManager)
        {
        ...
        {
            // TODO: we should be using a global RNG for this, not a local one
            ...
            do
            {
                ...
                octet1 = (byte) random.Next(20, 252);
                octet2 = (byte) random.Next(12, 253);
        ...
        public async Task RestoreWorld(IWorld worldToRestore)
        {
            ...
            {
                Log.Error("Attempting to restore the current world as a snapshot. Don't.");
                return;
            }
